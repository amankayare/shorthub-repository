...
<head>
  ...
  <!-- Argon CSS -->
  <link type="text/css" href="resources/assets/css/argon.css?v=1.0.1" rel="stylesheet">
  <!--side bar CSS -->
  <link href="resources/assets/css/simple-sidebar.css" rel="stylesheet">
</head>
                      ...
                      <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <div class="nav-wrapper">
                           <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
                            <li class="nav-item">
                             <a class="nav-link mb-sm-3 mb-md-0 active" id="tabs-icons-text-1-tab" data-toggle="tab" href="#tabs-icons-text-1" role="tab" aria-controls="tabs-icons-text-1" aria-selected="true"><i class="ni ni-cloud-upload-96 mr-2"></i>Login</a>
                            </li>
                            <li class="nav-item">
                             <a class="nav-link mb-sm-3 mb-md-0" id="tabs-icons-text-2-tab" data-toggle="tab" href="#tabs-icons-text-2" role="tab" aria-controls="tabs-icons-text-2" aria-selected="false"><i class="ni ni-bell-55 mr-2"></i>Signup</a>
                            </li>
                         </ul>
                     </div>
    ...
    <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light headroom">
      <div class="container">
        <a class="navbar-brand mr-lg-5" href="../index.html">
          <img src="resources/assets/img/brand/hikelogo.png">
        </a>
        ...
        <div class="navbar-collapse collapse" id="navbar_global">
          ...
          <ul class="navbar-nav align-items-lg-center ml-lg-auto">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="" target="_blank" data-toggle="tooltip" title="Join us on Telegram">
                <i class="fa fa-send"></i>
                <span class="nav-link-inner--text d-lg-none">Telegram group</span>
              </a>
            </li>
            -->
          <li class="nav-item">
              
            <button type="button" class="btn btn-icon btn-2 btn btn-lg btn-white btn-icon mb-3 mb-sm-0" data-toggle="modal" data-target="#modal-form"><span class="btn-inner--icon"><i class="ni ni-single-02"></i></span>
            </button>
          </li>  
            ...
            <div class="col-md-4">
             ...
             <li class="nav-item">
              <button class="btn btn-icon btn-2 btn btn-lg btn-white btn-icon mb-3 mb-sm-0 hide" type="button"  href="javascript:void(0);" class="icon" onclick="myFunction()">
  ...
  <main>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 mb-4">
         ...
         <!--  advertisement -->
           <div class="card">
              <div class="card-body py-5" id="advertisement">
                   <div class="container">
                      <form role="form">
                  <div class="form-group mb-3">
                    <div class="input-group input-group-alternative">
                  ...
                  <div class="card-body py-5">
                    <div class="icon icon-shape mb-4">
                     <a class="navbar-brand mr-lg-5" href="">
                       <img src="resources/assets/img/brand/rgpvlogo.png">
                     </a>           
                 </div>
                    <h6 class="text-primary text-uppercase">Download Technical</h6>
                    <p class="description mt-3">Technical is a great free study material based on latest RGPV 
                    syllabus that includes the most important topics with diagrams which will help you to cover the whole syllabus of RGPV</p>
                    <div>
                    ...
                    <a href="resources/examples/rgpvpage.html" class="btn btn-primary mt-4">Learn more</a>
                  </div>
                </div>
              </div>
              <div class="col-lg-12" style ="padding: 32px;">
                <div class="card card-lift--hover shadow border-0">
                  <div class="card-body py-5">
                    <div class="icon icon-shape mb-4">
                     <a class="navbar-brand mr-lg-5" href="">
                       <img src="resources/assets/img/brand/java.png">
                     </a>                     </div>
                    ...
                    <div>
                      ...
                      <span class="badge badge-pill badge-success">revision</span>
                      <span class="badge badge-pill badge-success">precise</span>
                    </div>
              ...
              <div class="col-lg-12" style ="padding: 32px;">
                <div class="card card-lift--hover shadow border-0">
                  <div class="card-body py-5">
                    <div class="icon icon-shape mb-4">
                     <a class="navbar-brand mr-lg-5" href="">
                       <img src="resources/assets/img/brand/c&c++.png">
                     </a>                    </div>
                    ...
                    <div>
                      <span class="badge badge-pill badge-warning">short</span>
                      <span class="badge badge-pill badge-warning">sweet</span>
                      <span class="badge badge-pill badge-warning">self-study</span>
                    </div>
...
<section class="section section-lg pt-0">
          ...
          <div class="col-lg-8">
            <div class="card bg-gradient-secondary shadow">
              <div class="card-body p-lg-5">
                ...
                <p class="mt-0">Your contribution is very important to us.</p>
    ...
    <div class="container">
      <div class="row row-grid align-items-center my-md">
        ...
        <div class="col-lg-6 text-lg-center btn-wrapper">
          ...
          <a target="_blank" href="" class="btn btn-neutral btn-icon-only btn-github btn-round btn-lg" data-toggle="tooltip" data-original-title="join us on Telegram">
      ...
      <div class="row align-items-center justify-content-md-between">
        <div class="col-md-6">
          <div class="copyright">
            &copy; 2018
            <a href="" target="_blank">ShortHub Team</a>.
          </div>
        </div>
        <div class="col-md-6">
          <ul class="nav nav-footer justify-content-end">
            <li class="nav-item">
              <a href="" class="nav-link" target="_blank">ShortHub Team</a>
            </li>
            <li class="nav-item">
  ...
  <!-- Argon JS -->
  <script src="resources/assets/js/argon.js?v=1.0.1"></script>
 <!-- loader js -->  
