  ...
  <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light headroom">
    <div class="container">
      <a class="navbar-brand mr-lg-5" href="../index.html">
        <img src="assets/img/brand/hikelogo.png">
      </a>
        ...
        <div class="navbar-collapse-header">
          <div class="row">
            <div class="col-6 collapse-brand">
              <a href="../index.html">
                <img src="assests/img/brand/hikelogo.png">
              </a>
            </div>
          ...
          <div class="card bg-gradient-info shadow-lg border-0">
            <div class="p-5">
              <div class="row align-items-center">
                <div class="col-lg-8">
                  <h3 class="text-white">We lllllll made this website to make technical things easier for you.</h3>
                  ...
                  <div class="card-body py-5">
                    <div class="icon icon-shape mb-4">
                     <a class="navbar-brand mr-lg-5" href="">
                       <img src="assests/img/brand/rgpvlogo.png">
                     </a>           
                   </div>
              ...
              <div class="col-lg-12" style ="padding: 32px;">
                <div class="card card-lift--hover shadow border-0">
                  <div class="card-body py-5">
                    <div class="icon icon-shape mb-4">
                     <a class="navbar-brand mr-lg-5" href="">
                       <img src="assests/img/brand/java.png">
                     </a>                     </div>
              ...
              <div class="col-lg-12" style ="padding: 32px;">
                <div class="card card-lift--hover shadow border-0">
                  <div class="card-body py-5">
                    <div class="icon icon-shape mb-4">
                     <a class="navbar-brand mr-lg-5" href="">
                       <img src="assests/img/brand/c&c++.png">
                     </a>                    </div>
